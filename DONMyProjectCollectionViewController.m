//
//  DONMyProjectCollectionViewController.m
//  Donateo
//
...
#import "DONMyProjectCollectionViewController.h"
...
@interface DONMyProjectCollectionViewController () {
    NSMutableArray *projects;
    int counter;
    NSString *message;
}
@end
@implementation DONMyProjectCollectionViewController
...
- (void)viewDidLoad
{
    ...
    self.collectionView.backgroundColor = [UIColor colorWithWhite:0.25f alpha:1.0f];
        ...
        NSURL *url=[NSURL URLWithString:@"http://localhost:8080/springmvc/listMyCurrentCrowdfundingsXML"];
